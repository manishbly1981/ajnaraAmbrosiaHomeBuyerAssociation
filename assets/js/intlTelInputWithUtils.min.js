...
(function(factory) {
    ...
    var factoryOutput = ( () => {
        ...
        var K2 = 0
          ...
          , V2 = ["800", "822", "833", "844", "855", "866", "877", "880", "881", "882", "883", "884", "885", "886", "887", "888", "889"]
          , c1 = g => g.replace(/\D/g, "")
          ...
          , T = (g, e, n) => {
            ...
            return e && Object.entries(e).forEach( ([u,l]) => r.setAttribute(u, l)),
            n && n.appendChild(r),
            r
        }
          , e1 = (g, ...e) => {
          ...
          , b1 = class {
            ...
            _addToDialCodeMap(e, n, r) {
                ...
                for (let l = 0; l < this.dialCodeToIso2Map[n].length; l++)
                    if (this.dialCodeToIso2Map[n][l] === e)
                        return;
            ...
            _generateMarkup() {
                ...
                let {allowDropdown: e, separateDialCode: n, showFlags: r, containerClass: u, hiddenInput: l, dropdownContainer: p, fixDropdownWidth: y, useFullscreenPopup: m, countrySearch: _, i18n: I} = this.options
                  , L = "iti";
                ...
                if (this.telInput.parentNode?.insertBefore(b, this.telInput),
                e || r || n) {
                    ...
                    e ? (this.selectedCountry = T("button", {
                        type: "button",
                    ...
                    this.telInput.disabled && this.selectedCountry.setAttribute("disabled", "true")) : this.selectedCountry = T("div", {
                        class: "iti__selected-country"
                    }, this.countryContainer);
                    let k = T("div", {
                    ...
                    this.selectedCountryA11yText = T("span", {
                        class: "iti__a11y-text"
                    }, this.selectedCountryInner),
                    e && (this.dropdownArrow = T("div", {
                        class: "iti__arrow",
                        "aria-hidden": "true"
                    }, k)),
                    n && (this.selectedDialCode = T("div", {
                    ...
                    e) {
                        ...
                        this.searchResultsA11yText = T("span", {
                            class: "iti__a11y-text"
                        }, this.dropdownContent)),
                        ...
                        p) {
                            ...
                            m ? N += " iti--fullscreen-popup" : N += " iti--inline-dropdown",
                            this.dropdown = T("div", {
                                class: N
                            }),
                ...
                if (b.appendChild(this.telInput),
            ...
            _appendListItems() {
                for (let e = 0; e < this.countries.length; e++) {
                    ...
                    let l = "";
                    this.options.showFlags && (l += `<div class='iti__flag iti__${n.iso2}'></div>`),
            ...
            _initRequests() {
                ...
                ,
                f.documentReady() ? this._handlePageLoad() : window.addEventListener("load", this._handlePageLoad)) : this.resolveUtilsScriptPromise(),
                n === "auto" && r && !this.selectedCountryData.iso2 ? this._loadAutoCountry() : this.resolveAutoCountryPromise()
            }
            _loadAutoCountry() {
                ...
                typeof this.options.geoIpLookup == "function" && this.options.geoIpLookup( (e="") => {
                    ...
                    setTimeout( () => e1("handleAutoCountry"))) : (this._setInitialState(!0),
            ...
            _initTelInputListeners() {
                let {strictMode: e, formatAsYouType: n, separateDialCode: r, formatOnDisplay: u, allowDropdown: l, countrySearch: p} = this.options
                  , y = !1;
                ...
                (e || r) && (this._handleKeydownEvent = m => {
            ...
            _openDropdown() {
                ...
                if (e && (this.dropdownContent.style.width = `${this.telInput.offsetWidth}px`),
            ...
            _setDropdownPosition() {
                ...
                !this.options.useFullscreenPopup) {
                    ...
                    this.options.dropdownContainer && (this.dropdown.style.top = `${e.top + n}px`,
            ...
            _bindDropdownListeners() {
                ...
                if (this._handleKeydownOnDropdown = u => {
                    ["ArrowUp", "ArrowDown", "Enter", "Escape"].includes(u.key) && (u.preventDefault(),
                    u.stopPropagation(),
                    u.key === "ArrowUp" || u.key === "ArrowDown" ? this._handleUpDownKey(u.key) : u.key === "Enter" ? this._handleEnterKey() : u.key === "Escape" && this._closeDropdown()),
                ...
                this.options.countrySearch) {
                    ...
                    this.searchInput.addEventListener("click", p => p.stopPropagation())
                }
            }
            _searchForCountry(e) {
            ...
            _updateSearchResultsText() {
                let {i18n: e} = this.options, n = this.countryList.childElementCount, r;
                n === 0 ? r = e.zeroSearchResults : n === 1 ? r = e.oneSearchResult : r = e.multipleSearchResults.replace("${count}", n.toString()),
            ...
            _handleUpDownKey(e) {
                ...
                !n && this.countryList.childElementCount > 1 && (n = e === "ArrowUp" ? this.countryList.lastElementChild : this.countryList.firstElementChild),
                n && (this._scrollTo(n),
            ...
            _highlightListItem(e, n) {
                ...
                if (r && (r.classList.remove("iti__highlight"),
                ...
                this.highlightedItem) {
                    ...
                    this.options.countrySearch && this.searchInput.setAttribute("aria-activedescendant", u)
                }
            ...
            _setCountry(e) {
                ...
                if (this.selectedCountryData = e ? this._getCountryData(e, !1) || {} : {},
                this.selectedCountryData.iso2 && (this.defaultCountry = this.selectedCountryData.iso2),
                this.selectedCountryInner) {
                    let p = ""
                      , y = "";
                    e && r ? (p = `iti__flag iti__${e}`,
                    y = `${this.selectedCountryData.name} +${this.selectedCountryData.dialCode}`) : (p = "iti__flag iti__globe",
                    y = u.noCountrySelected),
                    this.selectedCountryInner.className = p,
                    this.selectedCountryA11yText.textContent = y
                }
                if (this._setSelectedCountryTitleAttribute(e, n),
                n) {
            ...
            _updateMaxLength() {
                let {strictMode: e, placeholderNumberType: n, validationNumberTypes: r} = this.options
                ...
                if (e && f.utils)
                    if (u) {
                        let l = f.utils.numberType[n]
                          ...
                          , y = p;
                        for (; f.utils.isPossibleNumber(p, u, r); )
                            y = p,
                            p += "0";
            ...
            _setSelectedCountryTitleAttribute(e=null, n) {
                if (!this.selectedCountry)
                    return;
                let r;
                e && !n ? r = `${this.selectedCountryData.name}: +${this.selectedCountryData.dialCode}` : e ? r = this.selectedCountryData.name : r = "Unknown",
            ...
            _updatePlaceholder() {
                let {autoPlaceholder: e, placeholderNumberType: n, nationalMode: r, customPlaceholder: u} = this.options
                  , l = e === "aggressive" || !this.hadInitialPlaceholder && e === "polite";
                if (f.utils && l) {
            ...
            _updateDialCode(e) {
                let n = this.telInput.value, r = `+${e}`, u;
                if (n.charAt(0) === "+") {
                    let l = this._getDialCode(n);
                    l ? u = n.replace(l, r) : u = r,
                    this.telInput.value = u
                }
            }
            _getDialCode(e, n) {
                let r = "";
            ...
            _getFullNumber(e) {
                let n = e || this.telInput.value.trim(), {dialCode: r} = this.selectedCountryData, u, l = c1(n);
                return this.options.separateDialCode && n.charAt(0) !== "+" && r && l ? u = `+${r}` : u = "",
                u + n
            }
            _beforeSetNumber(e) {
                let n = e;
            ...
            destroy() {
                ...
                this._handleHiddenInputSubmit && r && r.removeEventListener("submit", this._handleHiddenInputSubmit),
                this.telInput.removeEventListener("input", this._handleInputEvent),
                this._handleKeydownEvent && this.telInput.removeEventListener("keydown", this._handleKeydownEvent),
                this.telInput.removeAttribute("data-intl-tel-input-id"),
                n && (this.isRTL ? this.telInput.style.paddingRight = this.originalPaddingRight : this.telInput.style.paddingLeft = this.originalPaddingLeft);
            ...
            _utilsIsPossibleNumber(e) {
                return f.utils ? f.utils.isPossibleNumber(e, this.selectedCountryData.iso2, this.options.validationNumberTypes) : null
            }
            ...
            _utilsIsValidNumber(e) {
                return f.utils ? f.utils.isValidNumber(e, this.selectedCountryData.iso2, this.options.validationNumberTypes) : null
            }
            setCountry(e) {
                let n = e?.toLowerCase()
                  , r = this.selectedCountryData.iso2;
                (e && n !== r || !e && r) && (this._setCountry(n),
            ...
            setDisabled(e) {
                ...
                e ? this.selectedCountry.setAttribute("disabled", "true") : this.selectedCountry.removeAttribute("disabled")
            }
        }
          , W2 = g => {
            if (!f.utils && !f.startedLoadingUtilsScript) {
                ...
                if (typeof g == "function")
                    ...
                    return Promise.reject(new TypeError(`The argument passed to attachUtils must be a function that returns a promise for the utilities module, not ${typeof g}`));
                return f.startedLoadingUtilsScript = !0,
                e.then(n => {
                    let r = n?.default;
                    ...
                    throw e1("rejectUtilsScriptPromise", n),
                    n
                }
                )
            }
        ...
        (function() {
            ...
            function e(d, t) {
                ...
                for (var i; d.length && (i = d.shift()); )
                    d.length || t === void 0 ? $[i] && $[i] !== Object.prototype[i] ? $ = $[i] : $ = $[i] = {} : $[i] = t
            }
            function n(d, t) {
                function $() {}
                ...
                d.sa = function(i, o, s) {
                    for (var a = Array(arguments.length - 2), h = 2; h < arguments.length; h++)
                        a[h - 2] = arguments[h];
                ...
                for (var $ = g2(d.m()), i = 0; i < $.length; i++) {
                    ...
                    if (x(t, s)) {
                        ...
                        if (o.l) {
                            ...
                            o = n1(t, s),
                            a ? (a = n1(d, s)) ? w1(a, o) : A(d, s, o.clone()) : A(d, s, o)
                    }
                }
            }
            ...
            r1.prototype.h = function(d, t) {
                ...
                if (d.h == 14)
                    return typeof t == "string" && E1.test(t) && (d = Number(t),
                    0 < d) ? d : t;
                if (!d.o)
                    return t;
                if (d = d.s,
                d === String) {
                    if (typeof t == "number")
                        return String(t)
                } else if (d === Number && typeof t == "string" && (t === "Infinity" || t === "-Infinity" || t === "NaN" || E1.test(t)))
                    return Number(t);
                return t
            }
            ;
            ...
            var g1 = {
              ...
              , S2 = /(?:.*?[A-Za-z]){3}.*/
              , L2 = RegExp("^\\+([0-9\uFF10-\uFF19\u0660-\u0669\u06F0-\u06F9]|[\\-\\.\\(\\)]?)*[0-9\uFF10-\uFF19\u0660-\u0669\u06F0-\u06F9]([0-9\uFF10-\uFF19\u0660-\u0669\u06F0-\u06F9]|[\\-\\.\\(\\)]?)*$")
              , w2 = RegExp("^([A-Za-z0-9\uFF10-\uFF19\u0660-\u0669\u06F0-\u06F9]+((\\-)*[A-Za-z0-9\uFF10-\uFF19\u0660-\u0669\u06F0-\u06F9])*\\.)*[A-Za-z]+((\\-)*[A-Za-z0-9\uFF10-\uFF19\u0660-\u0669\u06F0-\u06F9])*\\.?$");
            function Y(d) {
                return "([0-9\uFF10-\uFF19\u0660-\u0669\u06F0-\u06F9]{1," + d + "})"
            }
            function R1() {
                return ";ext=" + Y("20") + "|[ \xA0\\t,]*(?:e?xt(?:ensi(?:o\u0301?|\xF3))?n?|\uFF45?\uFF58\uFF54\uFF4E?|\u0434\u043E\u0431|anexo)[:\\.\uFF0E]?[ \xA0\\t,-]*" + (Y("20") + "#?|[ \xA0\\t,]*(?:[x\uFF58#\uFF03~\uFF5E]|int|\uFF49\uFF4E\uFF54)[:\\.\uFF0E]?[ \xA0\\t,-]*") + (Y("9") + "#?|[- ]+") + (Y("6") + "#|[ \xA0\\t]*(?:,{2}|;)[:\\.\uFF0E]?[ \xA0\\t,-]*") + (Y("15") + "#?|[ \xA0\\t]*(?:,)+[:\\.\uFF0E]?[ \xA0\\t,-]*") + (Y("9") + "#?")
            }
            var O1 = new RegExp("(?:" + R1() + ")$","i")
              , T2 = new RegExp("^[0-9\uFF10-\uFF19\u0660-\u0669\u06F0-\u06F9]{2}$|^[+\uFF0B]*(?:[-x\u2010-\u2015\u2212\u30FC\uFF0D-\uFF0F \xA0\xAD\u200B\u2060\u3000()\uFF08\uFF09\uFF3B\uFF3D.\\[\\]/~\u2053\u223C\uFF5E*]*[0-9\uFF10-\uFF19\u0660-\u0669\u06F0-\u06F9]){3,}[-x\u2010-\u2015\u2212\u30FC\uFF0D-\uFF0F \xA0\xAD\u200B\u2060\u3000()\uFF08\uFF09\uFF3B\uFF3D.\\[\\]/~\u2053\u223C\uFF5E*A-Za-z0-9\uFF10-\uFF19\u0660-\u0669\u06F0-\u06F9]*(?:" + R1() + ")?$","i")
              , E2 = /(\$\d)/
              , N2 = /^\(?\$1\)?$/;
            function k1(d) {
            ...
            M.prototype.format = function(d, t) {
                ...
                if (!($ in q))
                    return i;
                var o = Q(this, $, t1($));
                d = x(d, 3) && c(d, 3).length != 0 ? t == 3 ? ";ext=" + c(d, 3) : x(o, 13) ? c(o, 13) + v(d, 3) : " ext. " + v(d, 3) : "";
                d: {
                    o = D(o, 20).length == 0 || t == 2 ? D(o, 19) : D(o, 20);
                    for (var s, a = o.length, h = 0; h < a; ++h) {
                        s = o[h];
                        var C = G(s, 3);
                        if ((C == 0 || i.search(c(s, 3, C - 1)) == 0) && (C = new RegExp(c(s, 1)),
                        B(C, i))) {
                            o = s;
                            break d
                        }
                ...
                v(a, 5),
                a = v(a, 4),
                i = t == 2 && a != null && 0 < a.length ? i.replace(s, o.replace(E2, a)) : i.replace(s, o),
            ...
            function A2(d, t) {
                var $ = V1(d, t)
                  , i = v(t, 1)
                  , o = Q(d, i, $);
                return o == null || $ != "001" && i != j1(d, $) ? o = !1 : (d = d1(t),
                o = m1(d, o) != -1),
                o
            }
            function V1(d, t) {
            ...
            function a1(d, t, $, i) {
                ...
                i == 2)
                    if (G1(u1($, 0)))
                        d = u1($, 1),
                        G1(d) && (s = s.concat(G(d, 9) == 0 ? D(c($, 1), 9) : D(d, 9)),
                        s.sort(),
                        o.length == 0 ? o = D(d, 10) : (o = o.concat(D(d, 10)),
                        o.sort()));
                    else
                        return a1(d, t, $, 1);
                return s[0] == -1 ? 5 : (t = t.length,
                -1 < o.indexOf(t) ? 4 : ($ = s[0],
                $ == t ? 0 : $ > t ? 2 : s[s.length - 1] < t ? 3 : -1 < s.indexOf(t, 1) ? 0 : 5))
            }
            function l1(d, t, $) {
                var i = d1(t);
                return t = v(t, 1),
            ...
            function W1(d, t) {
                ...
                for (var $, i = d.length, o = 1; 3 >= o && o <= i; ++o)
                    if ($ = parseInt(d.substring(0, o), 10),
                    $ in q)
            ...
            function z1(d, t, $, i, o, s) {
                ...
                if (h.length == 0)
                    ...
                    a.search(h) == 0) {
                        ...
                        C && C[1] != null && 0 < C[1].length && o1(C[1], g1) == "0" ? a = !1 : (R(t),
                        t.g(a.substring(h)),
                        a = !0)
                    } else
                        a = !1;
                ...
                h = "" + a,
                C = t.toString(),
                C.lastIndexOf(h, 0) == 0 && (h = new w(C.substring(h.length)),
                C = c($, 1),
                C = new RegExp(v(C, 2)),
                Z1(h, $, null),
                h = h.toString(),
                !B(C, t.toString()) && B(C, h) || a1(d, t.toString(), $, -1) == 3)) ? (i.g(h),
                o && A(s, 6, 10),
                A(s, 1, a),
                a) : (A(s, 1, 0),
                0)
                ...
                if (o != 0 && s != null && s.length != 0) {
                    ...
                    if (o = a.exec(i)) {
                        ...
                        var h = B(s, i)
                          , C = o.length - 1;
                        t = c(t, 16),
                        t == null || t.length == 0 || o[C] == null || o[C].length == 0 ? (!h || B(s, i.substring(o[0].length))) && ($ != null && 0 < C && o[C] != null && $.g(o[1]),
                        d.set(i.substring(o[0].length))) : (i = i.replace(a, t),
                        (!h || B(s, i)) && ($ != null && 0 < C && $.g(o[1]),
                        d.set(i)))
                    }
                }
            }
            ...
            function Y1(d, t, $, i) {
                ...
                var h = s;
                if (h == null ? a = !0 : h.length === 0 ? a = !1 : (a = L2.exec(h),
                h = w2.exec(h),
                a = a !== null || h !== null),
                !a || (s != null ? (s.charAt(0) === "+" && o.g(s),
                s = t.indexOf("tel:"),
                o.g(t.substring(0 <= s ? s + 4 : 0, t.indexOf(";phone-context=")))) : (s = o.g,
                a = t ?? "",
                h = a.search(I2),
                0 <= h ? (a = a.substring(h),
                a = a.replace(b2, ""),
                h = a.search(_2),
                0 <= h && (a = a.substring(0, h))) : a = "",
                s.call(o, a)),
                s = o.toString(),
                a = s.indexOf(";isub="),
                0 < a && (R(o),
                ...
                t.g(o.toString()),
                $ != null ? (h = v(a, 10),
                A(s, 1, h)) : i && (delete s.h[6],
                s.g && delete s.g[6])),
                2 > t.h.length || (a != null && ($ = new w,
                o = new w(t.toString()),
                Z1(o, a, $),
            ...
            var J1 = new j;
            A(J1, 11, "NA");
            var D2 = RegExp("^[-x\u2010-\u2015\u2212\u30FC\uFF0D-\uFF0F \xA0\xAD\u200B\u2060\u3000()\uFF08\uFF09\uFF3B\uFF3D.\\[\\]/~\u2053\u223C\uFF5E]*\\$1[-x\u2010-\u2015\u2212\u30FC\uFF0D-\uFF0F \xA0\xAD\u200B\u2060\u3000()\uFF08\uFF09\uFF3B\uFF3D.\\[\\]/~\u2053\u223C\uFF5E]*(\\$\\d[-x\u2010-\u2015\u2212\u30FC\uFF0D-\uFF0F \xA0\xAD\u200B\u2060\u3000()\uFF08\uFF09\uFF3B\uFF3D.\\[\\]/~\u2053\u223C\uFF5E]*)*$")
              , q1 = /[- ]/;
            function X1(d, t) {
                var $ = d.ga;
                return t = s1(t) ? j1($, t) : 0,
                d = F(d.ga, t1(t)),
                d ?? J1
            }
            function Q1(d) {
                for (var t = d.j.length, $ = 0; $ < t; ++$) {
                    ...
                    if (H.length < C.g.h.length ? C = "" : (C = H.replace(new RegExp(h,"g"), a),
            ...
            function d2(d, t) {
                for (var $ = [], i = t.length - 3, o = d.j.length, s = 0; s < o; ++s) {
                    var a = d.j[s];
                    G(a, 3) == 0 ? $.push(d.j[s]) : (a = c(a, 3, Math.min(i, G(a, 3) - 1)),
            ...
            function P2(d, t) {
                d.s.g(t);
                var $ = t;
                if (x1.test($) || d.s.h.length == 1 && v2.test($) ? (t == "+" ? ($ = t,
                d.ba.g(t)) : ($ = g1[t],
                d.ba.g($),
                d.g.g($)),
                t = $) : (d.u = !1,
                ...
                case 3:
                    if (i2(d))
                        ...
                        C1(d);
                default:
                    return d.ea ? (r2(d) && (d.ea = !1),
                    d.h.toString() + d.g.toString()) : 0 < d.j.length ? (t = o2(d, t),
                    $ = e2(d),
                    0 < $.length ? $ : (d2(d, d.g.toString()),
                    Q1(d) ? $2(d) : d.u ? h1(d, t) : d.s.toString())) : C1(d)
                }
            }
            function t2(d) {
                return d.u = !0,
            ...
            function e2(d) {
                for (var t = d.g.toString(), $ = d.j.length, i = 0; i < $; ++i) {
                    var o = d.j[i]
                      , s = v(o, 1);
                    if (new RegExp("^(?:" + s + ")$").test(t) && (d.ha = q1.test(c(o, 4)),
            ...
            function C1(d) {
                var t = d.g.toString();
                if (3 <= t.length) {
                    for (var $ = d.ca && d.o.length == 0 && 0 < G(d.l, 20) ? D(d.l, 20) : D(d.l, 19), i = $.length, o = 0; o < i; ++o) {
                        var s = $[o];
                        0 < d.o.length && U1(v(s, 4)) && !c(s, 6) && !x(s, 5) || (d.o.length != 0 || d.ca || U1(v(s, 4)) || c(s, 6)) && D2.test(v(s, 2)) && d.j.push(s)
                    }
                    return d2(d, t),
                    t = e2(d),
            ...
            function n2(d) {
                ...
                return i ? ($ = 1,
                d.h.g("1").g(" "),
                d.ca = !0) : x(d.l, 15) && (i = new RegExp("^(?:" + c(d.l, 15) + ")"),
                i = t.match(i),
            ...
            function r2(d) {
                ...
                d.g.g(t.toString()),
                t = t1($),
                t == "001" ? d.l = F(d.ga, "" + $) : t != d.ka && (d.l = X1(d, t)),
                d.h.g("" + $).g(" "),
                d.o = "",
                !0)
            }
            ...
            e("intlTelInputUtilsTemp.isPossibleNumber", (d, t, $) => {
                try {
                    let i = M.g()
                      , o = W(i, d, t);
                    if ($) {
                        $.includes("FIXED_LINE_OR_MOBILE") && ($.includes("MOBILE") || $.push("MOBILE"),
