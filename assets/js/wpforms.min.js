    ...
    let m = {
        ...
        updateOrderSummaryItems(t, e, r) {
            t.find(".wpforms-order-summary-preview").each(function() {
                let e = p(this);
                "" !== r && e.find(".wpforms-order-summary-preview-total .wpforms-order-summary-item-price").text(r),
                t.find(".wpforms-payment-price").each(function() {
                    m.updateOrderSummaryItem(p(this), e)
                })
            })
        },
        updateCache(e, t, r) {
